...
`);
  ...
  // Preserves child elements (colored spans, em, etc.) and real whitespace between words
  charReveal(el, config) {
    if (!el) return;
    if (el.dataset.charRevealInit === 'true') return;
    el.dataset.charRevealInit = 'true';
